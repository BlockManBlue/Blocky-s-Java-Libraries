...
public class ParticleEmitter extends Entity{
    ...
    long spawnTimer = 0, spawnTime;
    int spawnAmount = 1;
    boolean debug = false;
    boolean worldBased = false;

    // Particle data
    boolean spawnCircles = false;
    boolean spawnSquares = true;
    boolean spawnImages = false;

    ArrayList<Color> circleColors = new ArrayList<Color>();
    ArrayList<Color> squareColors = new ArrayList<Color>();
    ArrayList<ImageIcon> images = new ArrayList<ImageIcon>();
    ArrayList<AnimImage> animImages = new ArrayList<AnimImage>();

    boolean fadeOut = false;

    int spawnType;
    static final int CIRCLE = 0, CONE = 1, RECT = 2;
    // cone
    int direction = 0, coneSize = 60;
    // rect
    Dimension spawnRect = new Dimension(10, 10);

    double speed = 0.25;
    long minLife = 700, maxLife = 2000;
    int size = 10;
